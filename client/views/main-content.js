window.MainContent = (function() {
  ...
  function reset() {
    log("Reset",{ system:"MainContent", level:1 });

    BackgroundImage.removeBackground();
    showCover();

    X.first('#mainContent').innerHTML = "";
  ...
  // The main content screens should all be loaded in a pretty similar way. We fetch an HTML template from the server,
