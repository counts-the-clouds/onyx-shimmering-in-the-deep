global.OnyxCalendar = (function() {

  // In the Onyx Calendar every day in the year has a unique name which is
  // generated from a pair of seasonal cycles. Between the 90 day seasons there
  // are four festivals with two festival days occurring at new years. This is
  ...
  function getTimeOfDay(timeCount) {
    hour = Math.floor(timeCount / OnyxCalendar.TicksPerHour) % 24;
...
OnyxCalendar.TicksPerHour = 60*60*6
OnyxCalendar.DayLength = 24 * OnyxCalendar.TicksPerHour;
OnyxCalendar.YearLength = 365
