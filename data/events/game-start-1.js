TileEvent.build('game-start-1', {

  stages:[{
    pages: [
      { text:`You wakes up in a thickly wooded forest at the bottom of a cliff. You are the only survivor of an
